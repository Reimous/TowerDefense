Public Class Proyectil
    Public Sub New(ByVal x As Single, ByVal y As Single, ByVal w As Single, ByVal h As Single, ByVal tipo As String, ByVal id As String, ByVal anguloObjetivo As Single, ByVal idObjetivo As String, ByVal puntoObjetivo As PointF, ByVal tBrush As TextureBrush)
        ...
        _id = id
        _daño = daño
        _anguloObjetivo = anguloObjetivo
        _idObjetivo = idObjetivo
        _puntoObjetivo = puntoObjetivo
        ...
        Try
            Select Case tipo
                Case "invader"
                    '_rAtaque = New Rectangle(x - _size.Width / 2 * (_radioAtaque - 1), y - _size.Height / 2 * (_radioAtaque - 1), _size.Width * _radioAtaque, _size.Height * _radioAtaque)
                    _daño = 8
                    _movConst = 5
                    _mov = _movConst
                    '_esperaDisparando = 500
                    '_esperaObjetivo = 0
    ...
    Private Sub rObjetoUpdate()
        ...
        '_rAtaque = New Rectangle(_puntoLocalizacion.X - _size.Width / 2 * (_radioAtaque - 1), _puntoLocalizacion.Y - _size.Height / 2 * (_radioAtaque - 1), _size.Width * _radioAtaque, _size.Height * _radioAtaque)
    End Sub
End Class
